...
CREATE TABLE `campus_chatroom`  (
  `chatroom_id` bigint NOT NULL AUTO_INCREMENT COMMENT '聊天室主键ID',
  `owner_id` bigint NULL DEFAULT NULL COMMENT '聊天室群主',
  `user_ids` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '聊天室用户列表',
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '聊天室名称',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`chatroom_id`) USING BTREE,
  INDEX `owner_id`(`owner_id`) USING BTREE,
  CONSTRAINT `campus_chatroom_ibfk_1` FOREIGN KEY (`owner_id`) REFERENCES `sys_user` (`user_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of campus_chatroom
-- ----------------------------
INSERT INTO `campus_chatroom` VALUES (1, 1594285543804383234, '{1739160897580417034:\"2023-12-27 21:52:36.192\",1:\"2023-12-27 21:52:36.192\",2:\"2023-12-27 21:52:36.192\",1594285543804383234:\"2023-12-27 21:52:36.192\"}', '我们的家', '2023-12-27 21:52:36');
INSERT INTO `campus_chatroom` VALUES (6, 1, '{1:\"2023-12-27 22:06:22.671\",2:\"2023-12-27 22:06:22.671\"}', 'KD后援团', '2023-12-27 22:06:23');
INSERT INTO `campus_chatroom` VALUES (7, 1594285543804383234, '{2:\"2023-12-27 22:06:44.944\",1594285543804383234:\"2023-12-27 22:06:44.944\"}', '180俱乐部', '2023-12-27 22:06:45');
INSERT INTO `campus_chatroom` VALUES (8, 1594285543804383234, '{1594285543804383234:\"2023-12-28 14:59:24.755\",1737940657664077827:\"2023-12-28 14:59:24.755\"}', '测试账号、用户1', '2023-12-28 14:59:25');
INSERT INTO `campus_chatroom` VALUES (9, 1594285543804383234, '{1:\"2023-12-28 16:08:13.589\",1594285543804383234:\"2023-12-28 16:08:13.589\",1737940657664077830:\"2023-12-28 16:08:13.589\"}', 'admin、测试账号、用户4', '2023-12-28 16:08:14');
...
CREATE TABLE `campus_message`  (
  ...
  `sender_id` bigint NULL DEFAULT NULL COMMENT '消息发送者ID',
  `receiver_id` bigint NULL DEFAULT NULL COMMENT '消息接送者ID-聊天室ID',
  ...
  `create_time` datetime(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '消息创建时间',
  PRIMARY KEY (`message_id`) USING BTREE,
  INDEX `message_id`(`message_id`) USING BTREE,
  INDEX `sender_id`(`sender_id`) USING BTREE,
  INDEX `receiver_id`(`receiver_id`) USING BTREE,
  CONSTRAINT `campus_message_ibfk_1` FOREIGN KEY (`sender_id`) REFERENCES `sys_user` (`user_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `campus_message_ibfk_2` FOREIGN KEY (`receiver_id`) REFERENCES `campus_chatroom` (`chatroom_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of campus_message
-- ----------------------------
INSERT INTO `campus_message` VALUES (2, 1594285543804383234, 1, '晚上好各位', 0, '2023-12-28 15:25:11');
INSERT INTO `campus_message` VALUES (4, 1594285543804383234, 1, '大家伙早咯', 0, '2023-12-28 15:23:42');
INSERT INTO `campus_message` VALUES (5, 1594285543804383234, 1, '大家伙早咯', 0, '2023-12-28 15:39:22');
...
) ENGINE = InnoDB AUTO_INCREMENT = 1739160897580417039 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = DYNAMIC;
...
INSERT INTO `campus_relation` VALUES (1739160897580417037, 1, 1594285543804383234, 1, '2023-12-27 18:56:52');
INSERT INTO `campus_relation` VALUES (1739160897580417039, 1594285543804383234, 1, -1, '2023-12-27 19:32:58');
...
) ENGINE = InnoDB AUTO_INCREMENT = 1740249747094478850 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_log_login` VALUES (1739899128554868738, 1594285543804383234, 'test', '0', '127.0.0.1', '内网IP', 'Chrome 12', 'Windows 10', '登录成功', '2023-12-27 14:40:53');
INSERT INTO `sys_log_login` VALUES (1739903841400741890, 1594285543804383234, 'test', '0', '127.0.0.1', '内网IP', 'Chrome 12', 'Windows 10', '登录成功', '2023-12-27 14:59:36');
INSERT INTO `sys_log_login` VALUES (1739933816195616769, 1594285543804383234, 'test', '0', '127.0.0.1', '内网IP', 'Unknown', 'Unknown', '登录成功', '2023-12-27 16:58:43');
INSERT INTO `sys_log_login` VALUES (1739936336921907202, 1594285543804383234, 'test', '0', '127.0.0.1', '内网IP', 'Unknown', 'Unknown', '登录成功', '2023-12-27 17:08:44');
INSERT INTO `sys_log_login` VALUES (1739938485823291393, 1, 'admin', '0', '127.0.0.1', '内网IP', 'Chrome 12', 'Windows 10', '登录成功', '2023-12-27 17:17:16');
INSERT INTO `sys_log_login` VALUES (1739961818900062209, 1594285543804383234, 'test', '0', '127.0.0.1', '内网IP', 'Chrome 12', 'Windows 10', '登录成功', '2023-12-27 18:49:59');
INSERT INTO `sys_log_login` VALUES (1739971345162674177, 1594285543804383234, 'test', '0', '127.0.0.1', '内网IP', 'Chrome 12', 'Windows 10', '登录成功', '2023-12-27 19:27:50');
INSERT INTO `sys_log_login` VALUES (1739975438895652866, 1594285543804383234, 'test', '0', '127.0.0.1', '内网IP', 'Unknown', 'Unknown', '登录成功', '2023-12-27 19:44:06');
INSERT INTO `sys_log_login` VALUES (1739983105273839618, 1, 'admin', '0', '127.0.0.1', '内网IP', 'Chrome 12', 'Windows 10', '登录成功', '2023-12-27 20:14:34');
INSERT INTO `sys_log_login` VALUES (1739983188883095553, 1594285543804383234, 'test', '0', '127.0.0.1', '内网IP', 'Unknown', 'Unknown', '登录成功', '2023-12-27 20:14:54');
INSERT INTO `sys_log_login` VALUES (1740005130042310657, 1, 'admin', '0', '127.0.0.1', '内网IP', 'Unknown', 'Unknown', '登录成功', '2023-12-27 21:42:05');
INSERT INTO `sys_log_login` VALUES (1740006471758229506, 1594285543804383234, 'test', '0', '127.0.0.1', '内网IP', 'Unknown', 'Unknown', '登录成功', '2023-12-27 21:47:25');
INSERT INTO `sys_log_login` VALUES (1740006878278574082, 1, 'admin', '0', '127.0.0.1', '内网IP', 'Unknown', 'Unknown', '登录成功', '2023-12-27 21:49:02');
INSERT INTO `sys_log_login` VALUES (1740006920125145089, 1594285543804383234, 'test', '0', '127.0.0.1', '内网IP', 'Unknown', 'Unknown', '登录成功', '2023-12-27 21:49:12');
INSERT INTO `sys_log_login` VALUES (1740006980170801153, 1, 'admin', '0', '127.0.0.1', '内网IP', 'Unknown', 'Unknown', '登录成功', '2023-12-27 21:49:26');
INSERT INTO `sys_log_login` VALUES (1740007256269250561, 1594285543804383234, 'test', '0', '127.0.0.1', '内网IP', 'Unknown', 'Unknown', '登录成功', '2023-12-27 21:50:32');
INSERT INTO `sys_log_login` VALUES (1740008405303025666, 1, 'admin', '0', '127.0.0.1', '内网IP', 'Unknown', 'Unknown', '登录成功', '2023-12-27 21:55:06');
INSERT INTO `sys_log_login` VALUES (1740011306167558146, 1594285543804383234, 'test', '0', '127.0.0.1', '内网IP', 'Unknown', 'Unknown', '登录成功', '2023-12-27 22:06:38');
INSERT INTO `sys_log_login` VALUES (1740013832191336450, 1594285543804383234, 'test', '0', '127.0.0.1', '内网IP', 'Chrome 12', 'Windows 10', '登录成功', '2023-12-27 22:16:40');
INSERT INTO `sys_log_login` VALUES (1740249663556526081, 1, 'admin', '0', '127.0.0.1', '内网IP', 'Chrome 12', 'Windows 10', '登录成功', '2023-12-28 13:53:47');
INSERT INTO `sys_log_login` VALUES (1740249747094478849, 1594285543804383234, 'test', '0', '127.0.0.1', '内网IP', 'Unknown', 'Unknown', '登录成功', '2023-12-28 13:54:07');
INSERT INTO `sys_log_login` VALUES (1740270899330248705, 1594285543804383234, 'test', '0', '127.0.0.1', '内网IP', 'Chrome 12', 'Windows 10', '登录成功', '2023-12-28 15:18:10');
...
-- ----------------------------
INSERT INTO `sys_resource` VALUES (1740355556218474498, 'oddfar', 'oddfar.sys_dict_type.edit', '字典类型管理-修改', 'SysDictTypeController', 'edit', '字典类型管理', '/system/dict/type', 'put', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556218474499, 'campus', 'campus.comment.list', 'list', 'CommentController', 'list', '评论管理', '/admin/comment/list', 'get', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556218474500, 'oddfar', 'oddfar.sys_dict_type.optionselect', '字典类型管理-获取字典选择框列表', 'SysDictTypeController', 'optionselect', '字典类型管理', '/system/dict/type/optionselect', 'get', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556218474501, 'campus', 'campus.category.edit', '修改分类', 'CategoryController', 'edit', '分类管理', '/admin/category', 'put', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556218474502, 'oddfar', 'oddfar.sys_login.get_routers', '获取路由信息', 'SysLoginController', 'getRouters', '登录路由', '/getRouters', 'get', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556218474503, 'message', 'message.message.delete_message', '删除消息', 'MessageController', 'deleteMessage', '消息api', '/message/deleteMessage', 'delete', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556218474504, 'oddfar', 'oddfar.sys_menu.tree_select', '菜单管理-获取菜单下拉树列表', 'SysMenuController', 'treeSelect', '菜单管理', '/system/menu/treeselect', 'get', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556218474505, 'campus', 'campus.user_action.image_upload', '图片文件上传', 'UserActionController', 'imageUpload', '用户操作api', '/campus/imageUpload', 'post', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556218474506, 'oddfar', 'oddfar.sys_role.remove', 'remove', 'SysRoleController', 'remove', '角色管理', '/system/role/{roleIds}', 'delete', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556264611841, 'oddfar', 'oddfar.sys_menu.role_menu_treeselect', '菜单管理-加载对应角色菜单列表树', 'SysMenuController', 'roleMenuTreeselect', '菜单管理', '/system/menu/roleMenuTreeselect/{roleId}', 'get', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556264611842, 'oddfar', 'oddfar.sys_profile.update_profile', 'updateProfile', 'SysProfileController', 'updateProfile', '个人信息管理', '/system/user/profile/个人信息管理-修改', 'put', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556264611843, 'campus', 'campus.user_account.send_reset_pwd_code', 'sendResetPwdCode', 'UserAccountController', 'sendResetPwdCode', '用户账户操作api', '/campus/pwd-code', 'post', 1, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556264611844, 'oddfar', 'oddfar.sys_role.add', 'add', 'SysRoleController', 'add', '角色管理', '/system/role', 'post', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556273000450, 'campus', 'campus.comment_info.to_comment', '添加评论', 'CommentInfoController', 'toComment', '评论api', '/campus/toComment', 'post', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556273000451, 'relation', 'relation.relation_info.cancel_block', '取消拉黑', 'RelationInfoController', 'cancelBlock', '关系api', '/relation/cancelBlock/{receiverID}', 'post', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556277194754, 'oddfar', 'oddfar.sys_login.login', '登录方法', 'SysLoginController', 'login', '登录路由', '/login', 'post', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556277194755, 'relation', 'relation.relation_info.get_block_list', '查询黑名单', 'RelationInfoController', 'getBlockList', '关系api', '/relation/blockList', 'get', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556277194756, 'oddfar', 'oddfar.sys_role.get_info', 'getInfo', 'SysRoleController', 'getInfo', '角色管理', '/system/role/{roleId}', 'get', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556277194757, 'message', 'message.message.send_message', '发送消息', 'MessageController', 'sendMessage', '消息api', '/message/sendMessage', 'post', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556277194758, 'oddfar', 'oddfar.sys_user.auth_role', 'authRole', 'SysUserController', 'authRole', '用户管理', '/system/user/authRole/{userId}', 'get', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556277194759, 'oddfar', 'oddfar.sys_config.edit', '参数配置管理-修改', 'SysConfigController', 'edit', '参数配置管理', '/system/config', 'put', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556277194760, 'oddfar', 'oddfar.sys_menu.edit', '菜单管理-修改', 'SysMenuController', 'edit', '菜单管理', '/system/menu', 'put', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556277194761, 'relation', 'relation.relation_info.cancel_special_follow', '取消特别关注', 'RelationInfoController', 'cancelSpecialFollow', '关系api', '/relation/cancelSpecialFollow/{receiverID}', 'put', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556277194762, 'campus', 'campus.content.page', '分页', 'ContentController', 'page', '内容管理', '/admin/content/list', 'get', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556277194763, 'oddfar', 'oddfar.sys_user.insert_auth_role', 'insertAuthRole', 'SysUserController', 'insertAuthRole', '用户管理', '/system/user/authRole', 'put', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556277194764, 'oddfar', 'oddfar.sys_logininfor.list', '登录日志-分类列表', 'SysLogininforController', 'list', '登录日志管理', '/monitor/logininfor/list', 'get', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556277194765, 'oddfar', 'oddfar.sys_config.refresh_cache', '参数配置管理-刷新缓存', 'SysConfigController', 'refreshCache', '参数配置管理', '/system/config/refreshCache', 'delete', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556277194766, 'oddfar', 'oddfar.sys_role.cancel_auth_user_all', 'cancelAuthUserAll', 'SysRoleController', 'cancelAuthUserAll', '角色管理', '/system/role/authUser/cancelAll', 'put', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556277194767, 'relation', 'relation.relation_info.get_special_follow_list', '查询特别关注列表', 'RelationInfoController', 'getSpecialFollowList', '关系api', '/relation/specialFollowList', 'get', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556277194768, 'oddfar', 'oddfar.sys_operlog.clean', '操作日志-清空', 'SysOperlogController', 'clean', '操作日志管理', '/monitor/operlog/clean', 'delete', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556277194769, 'oddfar', 'oddfar.sys_dict_type.get_info', '字典类型管理-查询', 'SysDictTypeController', 'getInfo', '字典类型管理', '/system/dict/type/{dictId}', 'get', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556277194770, 'oddfar', 'oddfar.sys_user.update', 'update', 'SysUserController', 'update', '用户管理', '/system/user', 'put', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556277194771, 'oddfar', 'oddfar.sys_api_resource.edit_role_resource', '修改对应角色api资源', 'SysApiResourceController', 'editRoleResource', '资源管理', '/system/resource/roleApi', 'put', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556277194772, 'oddfar', 'oddfar.sys_role.unallocated_list', 'unallocatedList', 'SysRoleController', 'unallocatedList', '角色管理', '/system/role/authUser/unallocatedList', 'get', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556277194773, 'oddfar', 'oddfar.sys_logininfor.clean', '登录日志-清空', 'SysLogininforController', 'clean', '登录日志管理', '/monitor/logininfor/clean', 'delete', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556277194774, 'campus', 'campus.campus_info.category_list', '查询分类列表', 'CampusInfoController', 'categoryList', '校园墙信息api', '/campus/categoryList', 'get', 1, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556277194775, 'campus', 'campus.content_info.del_content', '删除自己的校园墙', 'ContentInfoController', 'delContent', '信息墙api', '/campus/delContent/{contentId}', 'delete', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556277194776, 'oddfar', 'oddfar.sys_role.change_status', 'changeStatus', 'SysRoleController', 'changeStatus', '角色管理', '/system/role/changeStatus', 'put', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556277194777, 'message', 'message.chatroom.get_members', '获取聊天室成员', 'ChatroomController', 'getMembers', '聊天室api', '/chatroom/getMembers', 'get', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556277194778, 'oddfar', 'oddfar.sys_logininfor.remove', '登录日志-删除', 'SysLogininforController', 'remove', '登录日志管理', '/monitor/logininfor/{infoIds}', 'delete', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556277194779, 'campus', 'campus.tag.add', 'add', 'TagController', 'add', '标签管理', '/admin/tag', 'post', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556277194780, 'campus', 'campus.comment_info.get_comment', '添加评论', 'CommentInfoController', 'getComment', '评论api', '/campus/getComment', 'get', 1, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556277194781, 'relation', 'relation.relation_info.get_un_block_list', '查询非拉黑者名单', 'RelationInfoController', 'getUnBlockList', '关系api', '/relation/unBlockList', 'get', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556277194782, 'oddfar', 'oddfar.sys_dict_data.remove', '字典数据管理-删除', 'SysDictDataController', 'remove', '字典数据管理', '/system/dict/data/{dictCodes}', 'delete', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332097, 'message', 'message.chatroom.remove_members', '删除聊天室用户', 'ChatroomController', 'removeMembers', '聊天室api', '/chatroom/removeMembers', 'put', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332098, 'campus', 'campus.content_info.get_content_by_id', '查询信息墙详细内容', 'ContentInfoController', 'getContentById', '信息墙api', '/campus/getContent', 'get', 1, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332099, 'oddfar', 'oddfar.sys_dict_data.get_info', '字典数据管理-查询', 'SysDictDataController', 'getInfo', '字典数据管理', '/system/dict/data/{dictCode}', 'get', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332100, 'campus', 'campus.content_info.get_own_love_content', '查询点赞的信息墙列表', 'ContentInfoController', 'getOwnLoveContent', '信息墙api', '/campus/getOwnLoveContent', 'get', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332101, 'campus', 'campus.comment.add', 'add', 'CommentController', 'add', '评论管理', '/admin/comment', 'post', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332102, 'campus', 'campus.tag.list', 'list', 'TagController', 'list', '标签管理', '/admin/tag/list', 'get', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332103, 'message', 'message.message.update_message', '修改消息', 'MessageController', 'updateMessage', '消息api', '/message/updateMessage', 'put', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332104, 'oddfar', 'oddfar.sys_login.get_info', '获取用户信息', 'SysLoginController', 'getInfo', '登录路由', '/getInfo', 'get', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332105, 'campus', 'campus.content.get_info', '获取校园墙内容', 'ContentController', 'getInfo', '内容管理', '/admin/content/{contentId}', 'get', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332106, 'oddfar', 'oddfar.sys_user.reset_pwd', 'resetPwd', 'SysUserController', 'resetPwd', '用户管理', '/system/user/resetPwd', 'put', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332107, 'oddfar', 'oddfar.sys_menu.get_info', '菜单管理-查询', 'SysMenuController', 'getInfo', '菜单管理', '/system/menu/{menuId}', 'get', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332108, 'oddfar', 'oddfar.sys_role.cancel_auth_user', 'cancelAuthUser', 'SysRoleController', 'cancelAuthUser', '角色管理', '/system/role/authUser/cancel', 'put', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332109, 'oddfar', 'oddfar.sys_menu.remove', '菜单管理-删除', 'SysMenuController', 'remove', '菜单管理', '/system/menu/{menuId}', 'delete', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332110, 'oddfar', 'oddfar.sys_role.list', 'list', 'SysRoleController', 'list', '角色管理', '/system/role/list', 'get', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332111, 'oddfar', 'oddfar.sys_dict_type.refresh_cache', '字典类型管理-刷新', 'SysDictTypeController', 'refreshCache', '字典类型管理', '/system/dict/type/refreshCache', 'delete', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332112, 'oddfar', 'oddfar.sys_menu.add', '菜单管理-新增', 'SysMenuController', 'add', '菜单管理', '/system/menu', 'post', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332113, 'oddfar', 'oddfar.sys_user.page', 'page', 'SysUserController', 'page', '用户管理', '/system/user/list', 'get', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332114, 'oddfar', 'oddfar.sys_role.allocated_list', 'allocatedList', 'SysRoleController', 'allocatedList', '角色管理', '/system/role/authUser/allocatedList', 'get', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332115, 'relation', 'relation.relation_info.special_follow', '特别关注', 'RelationInfoController', 'specialFollow', '关系api', '/relation/specialFollow/{receiverID}', 'put', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332116, 'campus', 'campus.tag.remove', 'remove', 'TagController', 'remove', '标签管理', '/admin/tag/{tagIds}', 'delete', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332117, 'oddfar', 'oddfar.sys_dict_data.edit', '字典数据管理-修改', 'SysDictDataController', 'edit', '字典数据管理', '/system/dict/data', 'put', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332118, 'campus', 'campus.category.remove', '删除分类', 'CategoryController', 'remove', '分类管理', '/admin/category/{categoryId}', 'delete', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332119, 'campus', 'campus.user_account.send_mail', 'sendMail', 'UserAccountController', 'sendMail', '用户账户操作api', '/campus/bindMail', 'post', 1, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332120, 'oddfar', 'oddfar.sys_operlog.list', '操作日志-分页', 'SysOperlogController', 'list', '操作日志管理', '/monitor/operlog/list', 'get', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332121, 'campus', 'campus.category.add', '新增分类', 'CategoryController', 'add', '分类管理', '/admin/category', 'post', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332122, 'oddfar', 'oddfar.sys_role.select_auth_user_all', 'selectAuthUserAll', 'SysRoleController', 'selectAuthUserAll', '角色管理', '/system/role/authUser/selectAll', 'put', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332123, 'oddfar', 'oddfar.sys_config.add', '参数配置管理-新增', 'SysConfigController', 'add', '参数配置管理', '/system/config', 'post', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332124, 'oddfar', 'oddfar.sys_dict_type.remove', '字典类型管理-删除', 'SysDictTypeController', 'remove', '字典类型管理', '/system/dict/type/{dictIds}', 'delete', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332125, 'campus', 'campus.comment_info.get_comment_children_list', '查询一级评论的子评论', 'CommentInfoController', 'getCommentChildrenList', '评论api', '/campus/getCommentChildrenList', 'get', 1, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332126, 'campus', 'campus.content_info.update_content', '修改信息墙', 'ContentInfoController', 'updateContent', '信息墙api', '/campus/updateContent', 'put', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332127, 'campus', 'campus.content.remove', 'remove', 'ContentController', 'remove', '内容管理', '/admin/content/{contentIds}', 'delete', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332128, 'oddfar', 'oddfar.sys_config.get_info', '参数配置管理-查询id信息', 'SysConfigController', 'getInfo', '参数配置管理', '/system/config/{id}', 'get', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332129, 'relation', 'relation.relation_info.cancel_follow', '取消关注', 'RelationInfoController', 'cancelFollow', '关系api', '/relation/cancelFollow/{receiverID}', 'post', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332130, 'message', 'message.chatroom.get_chatroom', '获取用户所在的聊天室列表', 'ChatroomController', 'getChatroom', '聊天室api', '/chatroom/getChatroom', 'get', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332131, 'campus', 'campus.comment_info.get_own_comment_list', '分页查询自己发布或回复的评论列表', 'CommentInfoController', 'getOwnCommentList', '评论api', '/campus/getOwnComment', 'get', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332132, 'oddfar', 'oddfar.sys_config.remove', '参数配置管理-删除', 'SysConfigController', 'remove', '参数配置管理', '/system/config/{configIds}', 'delete', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332133, 'campus', 'campus.content.edit', '修改信息墙内容', 'ContentController', 'edit', '内容管理', '/admin/content/', 'put', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332134, 'oddfar', 'oddfar.sys_dict_data.add', '字典数据管理-新增', 'SysDictDataController', 'add', '字典数据管理', '/system/dict/data', 'post', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332135, 'campus', 'campus.content_info.own_contents', '查看自己的单个信息墙', 'ContentInfoController', 'ownContents', '信息墙api', '/campus/ownContents', 'post', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332136, 'oddfar', 'oddfar.sys_dict_data.dict_type', '字典数据管理-根据字典类型查询字典数据信息', 'SysDictDataController', 'dictType', '字典数据管理', '/system/dict/data/type/{dictType}', 'get', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332137, 'campus', 'campus.category.list', '查询分类列表', 'CategoryController', 'list', '分类管理', '/admin/category/list', 'get', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332138, 'oddfar', 'oddfar.sys_config.get_config_key', 'getConfigKey', 'SysConfigController', 'getConfigKey', '参数配置管理', '/system/config/configKey/{configKey:.+}', 'get', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332139, 'oddfar', 'oddfar.sys_profile.avatar', '个人信息管理-头像上次', 'SysProfileController', 'avatar', '个人信息管理', '/system/user/profile/avatar', 'post', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332140, 'oddfar', 'oddfar.sys_user.get_info', 'getInfo', 'SysUserController', 'getInfo', '用户管理', '/system/user/{userId}', 'get', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332141, 'message', 'message.message.get_message_by_ID', '获取指定聊天室消息', 'MessageController', 'getMessageByID', '消息api', '/message/getMessage', 'get', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332142, 'campus', 'campus.comment.edit', 'edit', 'CommentController', 'edit', '评论管理', '/admin/comment', 'put', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332143, 'campus', 'campus.comment_info.get_one_level_comment', '查询一级评论', 'CommentInfoController', 'getOneLevelComment', '评论api', '/campus/getOneLevelComment', 'get', 1, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332144, 'campus', 'campus.user_account.change_pwd', 'changePwd', 'UserAccountController', 'changePwd', '用户账户操作api', '/campus/changePwd', 'post', 1, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332145, 'oddfar', 'oddfar.sys_config.page', '参数配置管理-分页', 'SysConfigController', 'page', '参数配置管理', '/system/config/page', 'get', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332146, 'campus', 'campus.comment_info.get_comment_children', '分页查询一级评论的子评论', 'CommentInfoController', 'getCommentChildren', '评论api', '/campus/getCommentChildren', 'get', 1, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332147, 'campus', 'campus.comment_info.del_own_comment', '删除自己的评论', 'CommentInfoController', 'delOwnComment', '评论api', '/campus/delOwnComment', 'post', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332148, 'oddfar', 'oddfar.sys_menu.list', '菜单管理-分页', 'SysMenuController', 'list', '菜单管理', '/system/menu/list', 'get', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332149, 'campus', 'campus.content_info.get_content_by_condition', '条件查询信息墙', 'ContentInfoController', 'getContentByCondition', '信息墙api', '/campus/getContentByCondition', 'post', 1, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332150, 'campus', 'campus.user_action.zan_content', '点赞', 'UserActionController', 'zanContent', '用户操作api', '/campus/zan/{contentId}', 'get', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332151, 'message', 'message.chatroom.create_chat_room', '创建聊天室', 'ChatroomController', 'createChatRoom', '聊天室api', '/chatroom/createChatroom', 'post', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332152, 'relation', 'relation.relation_info.block', '拉黑', 'RelationInfoController', 'block', '关系api', '/relation/block/{receiverID}', 'post', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332153, 'oddfar', 'oddfar.sys_dict_type.list', '字典类型管理-分页', 'SysDictTypeController', 'list', '字典类型管理', '/system/dict/type/list', 'get', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332154, 'campus', 'campus.content_info.get_content_list', '查询信息墙内容列表', 'ContentInfoController', 'getContentList', '信息墙api', '/campus/contentList', 'get', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332155, 'oddfar', 'oddfar.sys_profile.update_pwd', '个人信息管理-重置密码', 'SysProfileController', 'updatePwd', '个人信息管理', '/system/user/profile/updatePwd', 'put', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332156, 'oddfar', 'oddfar.sys_user.remove', 'remove', 'SysUserController', 'remove', '用户管理', '/system/user/{userIds}', 'delete', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332157, 'campus', 'campus.user_account.email_validate', 'emailValidate', 'UserAccountController', 'emailValidate', '用户账户操作api', '/campus/email-validate', 'get', 1, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332158, 'campus', 'campus.user_account.have_mail', 'haveMail', 'UserAccountController', 'haveMail', '用户账户操作api', '/campus/haveMail', 'get', 1, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332159, 'campus', 'campus.content_info.to_content', '发表信息墙', 'ContentInfoController', 'toContent', '信息墙api', '/campus/sendContent', 'post', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332160, 'campus', 'campus.content_info.get_simple_hot_content', '查询信息墙内容列表', 'ContentInfoController', 'getSimpleHotContent', '信息墙api', '/campus/simpleHotContent', 'get', 1, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332161, 'oddfar', 'oddfar.sys_user.add', 'add', 'SysUserController', 'add', '用户管理', '/system/user', 'post', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556323332162, 'message', 'message.chatroom.remove_chatroom', '删除聊天室', 'ChatroomController', 'removeChatroom', '聊天室api', '/chatroom/removeChatroom', 'delete', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556390440961, 'campus', 'campus.category.list_select', '查询分类列表选择器', 'CategoryController', 'listSelect', '分类管理', '/admin/category/listSelect', 'get', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556390440962, 'campus', 'campus.user_action.video_upload', '视频文件上传', 'UserActionController', 'videoUpload', '用户操作api', '/campus/videoUpload', 'post', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556390440963, 'oddfar', 'oddfar.sys_user.change_status', 'changeStatus', 'SysUserController', 'changeStatus', '用户管理', '/system/user/changeStatus', 'put', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556390440964, 'oddfar', 'oddfar.sys_dict_data.page', '字典数据管理-分页', 'SysDictDataController', 'page', '字典数据管理', '/system/dict/data/list', 'get', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556390440965, 'campus', 'campus.campus_info.category_children', '查询分类子列表', 'CampusInfoController', 'categoryChildren', '校园墙信息api', '/campus/categoryChildren/{categoryId}', 'get', 1, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556390440966, 'campus', 'campus.category.get_info', '获取分类详细信息', 'CategoryController', 'getInfo', '分类管理', '/admin/category/{categoryId}', 'get', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556390440967, 'relation', 'relation.relation_info.follow', '关注', 'RelationInfoController', 'follow', '关系api', '/relation/follow/{receiverID}', 'post', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556390440968, 'oddfar', 'oddfar.sys_operlog.remove', '操作日志-删除', 'SysOperlogController', 'remove', '操作日志管理', '/monitor/operlog/{operIds}', 'delete', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556390440969, 'campus', 'campus.comment.get_info', 'getInfo', 'CommentController', 'getInfo', '评论管理', '/admin/comment/{commentId}', 'get', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556390440970, 'oddfar', 'oddfar.sys_api_resource.role_menu_tree_select', '资源管理-加载对应角色资源列表树', 'SysApiResourceController', 'roleMenuTreeSelect', '资源管理', '/system/resource/roleApiTreeselect/{roleId}', 'get', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556390440971, 'oddfar', 'oddfar.sys_profile.profile', '个人信息管理-查询', 'SysProfileController', 'profile', '个人信息管理', '/system/user/profile', 'get', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556390440972, 'oddfar', 'oddfar.sys_logininfor.unlock', '登录日志-解锁', 'SysLogininforController', 'unlock', '登录日志管理', '/monitor/logininfor/unlock/{userName}', 'get', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556390440973, 'oddfar', 'oddfar.sys_dict_type.add', '字典类型管理-新增', 'SysDictTypeController', 'add', '字典类型管理', '/system/dict/type', 'post', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556390440974, 'campus', 'campus.tag.get_info', 'getInfo', 'TagController', 'getInfo', '标签管理', '/admin/tag/{tagId}', 'get', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556390440975, 'campus', 'campus.tag.edit', 'edit', 'TagController', 'edit', '标签管理', '/admin/tag', 'put', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556390440976, 'relation', 'relation.relation_info.get_follow_list', '查询关注列表', 'RelationInfoController', 'getFollowList', '关系api', '/relation/followList', 'get', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556390440977, 'campus', 'campus.comment.remove', 'remove', 'CommentController', 'remove', '评论管理', '/admin/comment/{commentIds}', 'delete', 1, 'Y', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
INSERT INTO `sys_resource` VALUES (1740355556390440978, 'oddfar', 'oddfar.sys_role.edit', 'edit', 'SysRoleController', 'edit', '角色管理', '/system/role', 'put', 2, 'N', b'0', NULL, '2023-12-28 20:54:34', NULL, '2023-12-28 20:54:33');
...
INSERT INTO `sys_role_resource` VALUES ('campus.content_info.get_content_list', 2);
...
INSERT INTO `sys_role_resource` VALUES ('campus.content_info.update_content', 2);
...
INSERT INTO `sys_role_resource` VALUES ('campus.content_info.get_content_list', 1594285449147330561);
...
INSERT INTO `sys_role_resource` VALUES ('campus.content_info.update_content', 1594285449147330561);
...
INSERT INTO `sys_role_resource` VALUES ('campus.content_info.get_content_list', 1628997165540274178);
...
INSERT INTO `sys_role_resource` VALUES ('message.chatroom.create_chat_room', 1628997165540274178);
INSERT INTO `sys_role_resource` VALUES ('message.chatroom.get_chatroom', 1628997165540274178);
INSERT INTO `sys_role_resource` VALUES ('message.chatroom.get_members', 1628997165540274178);
INSERT INTO `sys_role_resource` VALUES ('message.chatroom.remove_chatroom', 1628997165540274178);
INSERT INTO `sys_role_resource` VALUES ('message.message.delete_message', 1628997165540274178);
INSERT INTO `sys_role_resource` VALUES ('message.message.get_message_by_ID', 1628997165540274178);
INSERT INTO `sys_role_resource` VALUES ('message.message.send_message', 1628997165540274178);
INSERT INTO `sys_role_resource` VALUES ('message.message.update_message', 1628997165540274178);
...
INSERT INTO `sys_role_resource` VALUES ('relation.relation_info.get_un_block_list', 1628997165540274178);
...
INSERT INTO `sys_role_resource` VALUES ('campus.content_info.get_content_list', 1628997651572027394);
...
INSERT INTO `sys_role_resource` VALUES ('campus.content_info.to_content', 1628997651572027394);
INSERT INTO `sys_role_resource` VALUES ('campus.content_info.update_content', 1628997651572027394);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'admin', 'admin', '00', 'oddfar@163.com', '15888888888', '0', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '127.0.0.1', '2023-12-28 13:53:47', '管理员', '我是管理员', '北京大学', 0, '2022-10-05 15:28:43', 1, '2023-12-28 13:53:47', b'0');
